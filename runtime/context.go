...
func NewFuncContext() *FunctionContext {
	...
	userConfigs := buildUserConfig(instanceConf.funcDetails.UserConfig)
...
func (c *FunctionContext) GetInputTopics() []string {
	inputMap := c.instanceConf.funcDetails.Source.InputSpecs
...
func (c *FunctionContext) GetOutputTopic() string {
	return c.instanceConf.funcDetails.Sink.Topic
}
